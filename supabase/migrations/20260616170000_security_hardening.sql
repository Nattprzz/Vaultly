-- ============================================================================
-- Nombre: security_hardening.sql
-- Descripcion:
-- Endurece privacidad real del tracker, usuarios suspendidos, perfiles y
-- soporte de rate limiting para Edge Functions publicas.
-- ============================================================================
...
create or replace view public.public_user_item_tracking
with (security_barrier = true) as
select
  t.id,
  t.user_id,

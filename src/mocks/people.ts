...
export const PEOPLE_MOCK: Record<string, Person> = {
  // ── Directors ──
  'denis-villeneuve': {
    id: 'denis-villeneuve',
    ...
    known_for: ['Dune', 'Blade Runner 2049', 'Arrival', 'Sicario'],
    works: [
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune2&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Director' },
      { id: 'dune1', title: 'Dune: Parte I', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20golden%20sky%20cinematic%20movie%20poster%20warm%20tones%20first%20part&width=280&height=380&seq=pw-dune1&orientation=portrait', year: 2021, genre: 'Sci-Fi', category: 'movies', rating: 8.6, role: 'Director' },
      { id: 'br2049', title: 'Blade Runner 2049', cover: 'https://readdy.ai/api/search-image?query=blade%20runner%202049%20futuristic%20city%20rain%20neon%20lights%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-br&orientation=portrait', year: 2017, genre: 'Sci-Fi', category: 'movies', rating: 8.7, role: 'Director' },
      { id: 'arrival', title: 'Arrival', cover: 'https://readdy.ai/api/search-image?query=alien%20contact%20sci-fi%20mysterious%20spacecraft%20fog%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-arr&orientation=portrait', year: 2016, genre: 'Sci-Fi', category: 'movies', rating: 8.9, role: 'Director' },
      { id: 'sicario', title: 'Sicario', cover: 'https://readdy.ai/api/search-image?query=border%20thriller%20desert%20dramatic%20sky%20dark%20cinematic%20movie%20poster%20tense%20atmosphere&width=280&height=380&seq=pw-sic&orientation=portrait', year: 2015, genre: 'Thriller', category: 'movies', rating: 8.5, role: 'Director' },
      { id: 'enemy', title: 'Enemy', cover: 'https://readdy.ai/api/search-image?query=psychological%20thriller%20doppelganger%20dark%20surreal%20cinematic%20movie%20poster%20yellow%20tones&width=280&height=380&seq=pw-ene&orientation=portrait', year: 2013, genre: 'Thriller', category: 'movies', rating: 8.1, role: 'Director' },
    ],
  },
  'christopher-nolan': {
    ...
    known_for: ['Oppenheimer', 'Inception', 'The Dark Knight', 'Interstellar'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'Director' },
      { id: 'm5', title: 'Interstellar', cover: 'https://readdy.ai/api/search-image?query=space%20wormhole%20galaxy%20stars%20dramatic%20cosmic%20cinematic%20sci-fi%20movie%20poster%20dark%20blue%20tones&width=280&height=380&seq=pw-int&orientation=portrait', year: 2014, genre: 'Sci-Fi', category: 'movies', rating: 9.3, role: 'Director' },
      { id: 'inception', title: 'Inception', cover: 'https://readdy.ai/api/search-image?query=dream%20city%20folding%20architecture%20surreal%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-inc&orientation=portrait', year: 2010, genre: 'Sci-Fi', category: 'movies', rating: 9.2, role: 'Director' },
      { id: 'tdk', title: 'The Dark Knight', cover: 'https://readdy.ai/api/search-image?query=batman%20dark%20knight%20joker%20dramatic%20dark%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-tdk&orientation=portrait', year: 2008, genre: 'Acción', category: 'movies', rating: 9.5, role: 'Director' },
      { id: 'dunkirk', title: 'Dunkirk', cover: 'https://readdy.ai/api/search-image?query=world%20war%20II%20beach%20dramatic%20sky%20soldiers%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-dunk&orientation=portrait', year: 2017, genre: 'Drama', category: 'movies', rating: 8.6, role: 'Director' },
    ],
  },
  // ── Actors ──
  'cillian-murphy': {
    ...
    known_for: ['Oppenheimer', 'Peaky Blinders', 'Batman Begins', '28 Days Later'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp2&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'J. Robert Oppenheimer' },
      { id: 'peaky', title: 'Peaky Blinders', cover: 'https://readdy.ai/api/search-image?query=1920s%20gangster%20birmingham%20dark%20dramatic%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-pb&orientation=portrait', year: 2013, genre: 'Drama', category: 'series', rating: 9.1, role: 'Tommy Shelby' },
      { id: 'batman-begins', title: 'Batman Begins', cover: 'https://readdy.ai/api/search-image?query=batman%20dark%20knight%20begins%20dramatic%20dark%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-bb&orientation=portrait', year: 2005, genre: 'Acción', category: 'movies', rating: 8.7, role: 'Dr. Jonathan Crane' },
      { id: 'inception2', title: 'Inception', cover: 'https://readdy.ai/api/search-image?query=dream%20city%20folding%20architecture%20surreal%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-inc2&orientation=portrait', year: 2010, genre: 'Sci-Fi', category: 'movies', rating: 9.2, role: 'Robert Fischer' },
    ],
  },
  'timothee-chalamet': {
    ...
    known_for: ['Dune', 'Call Me by Your Name', 'Little Women', 'Wonka'],
    works: [
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune2b&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Paul Atreides' },
      { id: 'dune1b', title: 'Dune: Parte I', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20golden%20sky%20cinematic%20movie%20poster%20warm%20tones%20first%20part&width=280&height=380&seq=pw-dune1b&orientation=portrait', year: 2021, genre: 'Sci-Fi', category: 'movies', rating: 8.6, role: 'Paul Atreides' },
      { id: 'cmbyn', title: 'Call Me by Your Name', cover: 'https://readdy.ai/api/search-image?query=summer%20italy%20romance%20dramatic%20warm%20sunlight%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-cmbyn&orientation=portrait', year: 2017, genre: 'Romance', category: 'movies', rating: 8.8, role: 'Elio Perlman' },
      { id: 'wonka', title: 'Wonka', cover: 'https://readdy.ai/api/search-image?query=chocolate%20factory%20fantasy%20colorful%20whimsical%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-wonka&orientation=portrait', year: 2023, genre: 'Fantasía', category: 'movies', rating: 7.9, role: 'Willy Wonka' },
    ],
  },
  'zendaya': {
    id: 'zendaya',
    ...
    known_for: ['Dune', 'Euphoria', 'Spider-Man', 'The Greatest Showman'],
    works: [
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune-zen&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Chani' },
      { id: 'dune1-zen', title: 'Dune: Parte I', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20golden%20sky%20cinematic%20movie%20poster%20warm%20tones%20first%20part&width=280&height=380&seq=pw-dune1-zen&orientation=portrait', year: 2021, genre: 'Sci-Fi', category: 'movies', rating: 8.6, role: 'Chani' },
      { id: 'euphoria', title: 'Euphoria', cover: 'https://readdy.ai/api/search-image?query=teen%20drama%20neon%20lights%20dark%20atmospheric%20cinematic%20series%20poster%20vibrant%20tones&width=280&height=380&seq=pw-euph&orientation=portrait', year: 2019, genre: 'Drama', category: 'series', rating: 8.7, role: 'Rue Bennett' },
      { id: 'challengers', title: 'Challengers', cover: 'https://readdy.ai/api/search-image?query=tennis%20sport%20drama%20romantic%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-chal&orientation=portrait', year: 2024, genre: 'Drama', category: 'movies', rating: 8.1, role: 'Tashi Duncan' },
    ],
  },
  'emily-blunt': {
    id: 'emily-blunt',
    ...
    known_for: ['Oppenheimer', 'A Quiet Place', 'Edge of Tomorrow', 'The Devil Wears Prada'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp-eb&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'Kitty Oppenheimer' },
      { id: 'quiet-place', title: 'A Quiet Place', cover: 'https://readdy.ai/api/search-image?query=horror%20thriller%20silence%20forest%20dramatic%20dark%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-aqp&orientation=portrait', year: 2018, genre: 'Terror', category: 'movies', rating: 8.4, role: 'Evelyn Abbott' },
      { id: 'edge-tomorrow', title: 'Edge of Tomorrow', cover: 'https://readdy.ai/api/search-image?query=sci-fi%20war%20mech%20suit%20battle%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-eot&orientation=portrait', year: 2014, genre: 'Sci-Fi', category: 'movies', rating: 8.5, role: 'Rita Vrataski' },
    ],
  },
  'matt-damon': {
    id: 'matt-damon',
    ...
    known_for: ['Oppenheimer', 'Good Will Hunting', 'The Martian', 'Jason Bourne'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp-md&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'General Leslie Groves' },
      { id: 'martian', title: 'The Martian', cover: 'https://readdy.ai/api/search-image?query=mars%20planet%20astronaut%20survival%20sci-fi%20dramatic%20cinematic%20movie%20poster%20red%20tones&width=280&height=380&seq=pw-mart&orientation=portrait', year: 2015, genre: 'Sci-Fi', category: 'movies', rating: 8.6, role: 'Mark Watney' },
      { id: 'interstellar-md', title: 'Interstellar', cover: 'https://readdy.ai/api/search-image?query=space%20wormhole%20galaxy%20stars%20dramatic%20cosmic%20cinematic%20sci-fi%20movie%20poster%20dark%20blue%20tones&width=280&height=380&seq=pw-int-md&orientation=portrait', year: 2014, genre: 'Sci-Fi', category: 'movies', rating: 9.3, role: 'Dr. Mann' },
    ],
  },
  'robert-downey-jr': {
    id: 'robert-downey-jr',
    ...
    known_for: ['Iron Man', 'Oppenheimer', 'Sherlock Holmes', 'Avengers: Endgame'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp-rdj&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'Lewis Strauss' },
      { id: 'iron-man', title: 'Iron Man', cover: 'https://readdy.ai/api/search-image?query=iron%20man%20superhero%20suit%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-im&orientation=portrait', year: 2008, genre: 'Acción', category: 'movies', rating: 8.6, role: 'Tony Stark / Iron Man' },
      { id: 'endgame', title: 'Avengers: Endgame', cover: 'https://readdy.ai/api/search-image?query=avengers%20superhero%20epic%20battle%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-eg&orientation=portrait', year: 2019, genre: 'Acción', category: 'movies', rating: 9.0, role: 'Tony Stark / Iron Man' },
    ],
  },
  'florence-pugh': {
    id: 'florence-pugh',
    ...
    known_for: ['Oppenheimer', 'Dune: Parte II', 'Little Women', 'Midsommar'],
    works: [
      { id: 'm2', title: 'Oppenheimer', cover: 'https://readdy.ai/api/search-image?query=atomic%20bomb%20explosion%20dramatic%20fire%20mushroom%20cloud%20dark%20cinematic%20historical%20movie%20poster&width=280&height=380&seq=pw-opp-fp&orientation=portrait', year: 2023, genre: 'Drama', category: 'movies', rating: 8.9, role: 'Jean Tatlock' },
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune-fp&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Princesa Irulan' },
      { id: 'midsommar', title: 'Midsommar', cover: 'https://readdy.ai/api/search-image?query=folk%20horror%20summer%20festival%20bright%20dramatic%20cinematic%20movie%20poster%20light%20tones&width=280&height=380&seq=pw-mid2&orientation=portrait', year: 2019, genre: 'Terror', category: 'movies', rating: 8.2, role: 'Dani Ardor' },
    ],
  },
  'rebecca-ferguson': {
    id: 'rebecca-ferguson',
    ...
    known_for: ['Dune', 'Mission: Impossible', 'Doctor Sleep', 'The Greatest Showman'],
    works: [
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune-rf&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Lady Jessica' },
      { id: 'dune1-rf', title: 'Dune: Parte I', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20golden%20sky%20cinematic%20movie%20poster%20warm%20tones%20first%20part&width=280&height=380&seq=pw-dune1-rf&orientation=portrait', year: 2021, genre: 'Sci-Fi', category: 'movies', rating: 8.6, role: 'Lady Jessica' },
      { id: 'mi-rogue', title: 'Mission: Impossible — Rogue Nation', cover: 'https://readdy.ai/api/search-image?query=spy%20action%20thriller%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-mi&orientation=portrait', year: 2015, genre: 'Acción', category: 'movies', rating: 8.3, role: 'Ilsa Faust' },
    ],
  },
  'austin-butler': {
    id: 'austin-butler',
    ...
    known_for: ['Dune: Parte II', 'Elvis', 'The Bikeriders'],
    works: [
      { id: 'm1', title: 'Dune: Parte II', cover: 'https://readdy.ai/api/search-image?query=Dune%20desert%20planet%20sci-fi%20epic%20sand%20dunes%20dramatic%20sky%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-dune-ab&orientation=portrait', year: 2024, genre: 'Sci-Fi', category: 'movies', rating: 8.8, role: 'Feyd-Rautha Harkonnen' },
      { id: 'elvis', title: 'Elvis', cover: 'https://readdy.ai/api/search-image?query=rock%20and%20roll%201950s%20performer%20stage%20dramatic%20cinematic%20movie%20poster%20warm%20tones&width=280&height=380&seq=pw-elvis&orientation=portrait', year: 2022, genre: 'Drama', category: 'movies', rating: 8.4, role: 'Elvis Presley' },
    ],
  },
  'pedro-pascal': {
    id: 'pedro-pascal',
    ...
    known_for: ['The Last of Us', 'The Mandalorian', 'Game of Thrones', 'Narcos'],
    works: [
      { id: 's1', title: 'The Last of Us', cover: 'https://readdy.ai/api/search-image?query=post%20apocalyptic%20city%20overgrown%20nature%20dramatic%20lighting%20dark%20moody%20atmosphere%20cinematic%20series%20poster&width=280&height=380&seq=pw-tlou&orientation=portrait', year: 2023, genre: 'Drama', category: 'series', rating: 9.1, role: 'Joel Miller' },
      { id: 'mando', title: 'The Mandalorian', cover: 'https://readdy.ai/api/search-image?query=star%20wars%20mandalorian%20space%20western%20dramatic%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-mando&orientation=portrait', year: 2019, genre: 'Sci-Fi', category: 'series', rating: 8.8, role: 'Din Djarin' },
      { id: 'narcos', title: 'Narcos', cover: 'https://readdy.ai/api/search-image?query=colombia%20drug%20cartel%20crime%20thriller%20dramatic%20cinematic%20series%20poster%20warm%20tones&width=280&height=380&seq=pw-narcos&orientation=portrait', year: 2015, genre: 'Drama', category: 'series', rating: 8.9, role: 'Javier Peña' },
      { id: 'got-pp', title: 'Game of Thrones', cover: 'https://readdy.ai/api/search-image?query=medieval%20fantasy%20throne%20dramatic%20dark%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-got&orientation=portrait', year: 2011, genre: 'Fantasía', category: 'series', rating: 9.2, role: 'Oberyn Martell' },
    ],
  },
  'bella-ramsey': {
    id: 'bella-ramsey',
    ...
    known_for: ['The Last of Us', 'Game of Thrones', 'Hilda'],
    works: [
      { id: 's1', title: 'The Last of Us', cover: 'https://readdy.ai/api/search-image?query=post%20apocalyptic%20city%20overgrown%20nature%20dramatic%20lighting%20dark%20moody%20atmosphere%20cinematic%20series%20poster&width=280&height=380&seq=pw-tlou-br&orientation=portrait', year: 2023, genre: 'Drama', category: 'series', rating: 9.1, role: 'Ellie Williams' },
      { id: 'got-br', title: 'Game of Thrones', cover: 'https://readdy.ai/api/search-image?query=medieval%20fantasy%20throne%20dramatic%20dark%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-got-br&orientation=portrait', year: 2016, genre: 'Fantasía', category: 'series', rating: 9.2, role: 'Lyanna Mormont' },
    ],
  },
  'gabriel-luna': {
    id: 'gabriel-luna',
    ...
    known_for: ['The Last of Us', 'Terminator: Dark Fate', 'Agents of S.H.I.E.L.D.'],
    works: [
      { id: 's1', title: 'The Last of Us', cover: 'https://readdy.ai/api/search-image?query=post%20apocalyptic%20city%20overgrown%20nature%20dramatic%20lighting%20dark%20moody%20atmosphere%20cinematic%20series%20poster&width=280&height=380&seq=pw-tlou-gl&orientation=portrait', year: 2023, genre: 'Drama', category: 'series', rating: 9.1, role: 'Tommy Miller' },
      { id: 'terminator-df', title: 'Terminator: Dark Fate', cover: 'https://readdy.ai/api/search-image?query=terminator%20robot%20sci-fi%20action%20dramatic%20cinematic%20movie%20poster%20dark%20tones&width=280&height=380&seq=pw-tdf&orientation=portrait', year: 2019, genre: 'Acción', category: 'movies', rating: 7.4, role: 'Rev-9' },
    ],
  },
  'anna-torv': {
    id: 'anna-torv',
    ...
    known_for: ['The Last of Us', 'Fringe', 'Mindhunter'],
    works: [
      { id: 's1', title: 'The Last of Us', cover: 'https://readdy.ai/api/search-image?query=post%20apocalyptic%20city%20overgrown%20nature%20dramatic%20lighting%20dark%20moody%20atmosphere%20cinematic%20series%20poster&width=280&height=380&seq=pw-tlou-at&orientation=portrait', year: 2023, genre: 'Drama', category: 'series', rating: 9.1, role: 'Tess' },
      { id: 'fringe', title: 'Fringe', cover: 'https://readdy.ai/api/search-image?query=sci-fi%20mystery%20investigation%20dramatic%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-fringe&orientation=portrait', year: 2008, genre: 'Sci-Fi', category: 'series', rating: 8.5, role: 'Olivia Dunham' },
      { id: 'mindhunter', title: 'Mindhunter', cover: 'https://readdy.ai/api/search-image?query=crime%20thriller%20FBI%20investigation%20dark%20dramatic%20cinematic%20series%20poster%20dark%20tones&width=280&height=380&seq=pw-mh&orientation=portrait', year: 2017, genre: 'Thriller', category: 'series', rating: 8.9, role: 'Wendy Carr' },
    ],
  },
  'adam-scott': {
    id: 'adam-scott',
    ...
    known_for: ['Severance', 'Parks and Recreation', 'Big Little Lies'],
    works: [
      { id: 's2', title: 'Severance', cover: 'https://readdy.ai/api/search-image?query=corporate%20office%20surreal%20minimalist%20dark%20thriller%20dramatic%20lighting%20cinematic%20series%20poster&width=280&height=380&seq=pw-sev-as&orientation=portrait', year: 2022, genre: 'Thriller', category: 'series', rating: 9.0, role: 'Mark Scout' },
      { id: 'parks-rec', title: 'Parks and Recreation', cover: 'https://readdy.ai/api/search-image?query=comedy%20government%20office%20warm%20colorful%20cinematic%20series%20poster%20warm%20tones&width=280&height=380&seq=pw-pr&orientation=portrait', year: 2009, genre: 'Comedia', category: 'series', rating: 8.8, role: 'Ben Wyatt' },
    ],
  },
  'britt-lower': {
    id: 'britt-lower',
    ...
    known_for: ['Severance', 'Crashing', 'High Maintenance'],
    works: [
      { id: 's2', title: 'Severance', cover: 'https://readdy.ai/api/search-image?query=corporate%20office%20surreal%20minimalist%20dark%20thriller%20dramatic%20lighting%20cinematic%20series%20poster&width=280&height=380&seq=pw-sev-bl&orientation=portrait', year: 2022, genre: 'Thriller', category: 'series', rating: 9.0, role: 'Helly R.' },
    ],
  },
  // ── Artists ──
  'taylor-swift': {
    ...
    known_for: ['Eras Tour', 'Midnights', 'Folklore', '1989'],
    works: [
      { id: 'c1', title: 'Taylor Swift — Eras Tour', cover: 'https://readdy.ai/api/search-image?query=concert%20stage%20spectacular%20lights%20show%20performer%20crowd%20energy%20colorful%20beams%20dramatic%20atmosphere%20music%20event&width=280&height=380&seq=pw-ts&orientation=portrait', year: 2024, genre: 'Pop', category: 'concerts', rating: 9.7, role: 'Artista principal' },
      { id: 'midnights', title: 'Midnights (álbum)', cover: 'https://readdy.ai/api/search-image?query=midnight%20dark%20blue%20stars%20moon%20album%20cover%20artistic%20music%20pop&width=280&height=380&seq=pw-mid&orientation=portrait', year: 2022, genre: 'Pop', category: 'concerts', rating: 9.1, role: 'Artista' },
      { id: 'folklore', title: 'Folklore (álbum)', cover: 'https://readdy.ai/api/search-image?query=forest%20misty%20atmospheric%20indie%20folk%20album%20cover%20artistic%20music&width=280&height=380&seq=pw-folk&orientation=portrait', year: 2020, genre: 'Indie Folk', category: 'concerts', rating: 9.4, role: 'Artista' },
    ],
  },
  // ── Book authors ──
  'liu-cixin': {
    ...
    known_for: ['El Problema de los Tres Cuerpos', 'El Bosque Oscuro', 'El Fin de la Muerte'],
    works: [
      { id: 'b1', title: 'El Problema de los Tres Cuerpos', cover: 'https://readdy.ai/api/search-image?query=science%20fiction%20book%20cover%20space%20stars%20three%20body%20problem%20cosmic%20dark%20background%20artistic%20illustration&width=280&height=380&seq=pw-3b&orientation=portrait', year: 2008, genre: 'Sci-Fi', category: 'books', rating: 9.0, role: 'Autor' },
      { id: 'dark-forest', title: 'El Bosque Oscuro', cover: 'https://readdy.ai/api/search-image?query=dark%20forest%20space%20sci-fi%20cosmic%20book%20cover%20artistic%20illustration%20dark%20tones&width=280&height=380&seq=pw-df&orientation=portrait', year: 2008, genre: 'Sci-Fi', category: 'books', rating: 9.2, role: 'Autor' },
      { id: 'end-death', title: 'El Fin de la Muerte', cover: 'https://readdy.ai/api/search-image?query=cosmic%20space%20death%20stars%20sci-fi%20book%20cover%20artistic%20illustration%20dark%20tones&width=280&height=380&seq=pw-ed&orientation=portrait', year: 2010, genre: 'Sci-Fi', category: 'books', rating: 9.1, role: 'Autor' },
      { id: 'ball-lightning', title: 'Bola de Rayo', cover: 'https://readdy.ai/api/search-image?query=lightning%20ball%20energy%20sci-fi%20book%20cover%20artistic%20illustration%20dramatic%20tones&width=280&height=380&seq=pw-bl&orientation=portrait', year: 2004, genre: 'Sci-Fi', category: 'books', rating: 8.4, role: 'Autor' },
    ],
  },
  'frank-herbert': {
    id: 'frank-herbert',
    ...
    known_for: ['Dune', 'El Mesías de Dune', 'Hijos de Dune'],
    works: [
      { id: 'b2', title: 'Dune', cover: 'https://readdy.ai/api/search-image?query=desert%20planet%20sci-fi%20book%20cover%20sand%20dunes%20dramatic%20sky%20artistic%20illustration%20warm%20tones&width=280&height=380&seq=pw-duneb-fh&orientation=portrait', year: 1965, genre: 'Sci-Fi', category: 'books', rating: 9.4, role: 'Autor' },
      { id: 'dune-messiah', title: 'El Mesías de Dune', cover: 'https://readdy.ai/api/search-image?query=desert%20planet%20sci-fi%20book%20cover%20sand%20dunes%20dramatic%20sky%20artistic%20illustration%20warm%20tones%20sequel&width=280&height=380&seq=pw-dm&orientation=portrait', year: 1969, genre: 'Sci-Fi', category: 'books', rating: 8.8, role: 'Autor' },
      { id: 'children-dune', title: 'Hijos de Dune', cover: 'https://readdy.ai/api/search-image?query=desert%20planet%20sci-fi%20book%20cover%20sand%20dunes%20dramatic%20sky%20artistic%20illustration%20warm%20tones%20third&width=280&height=380&seq=pw-cd&orientation=portrait', year: 1976, genre: 'Sci-Fi', category: 'books', rating: 8.6, role: 'Autor' },
    ],
  },
  'george-orwell': {
    id: 'george-orwell',
    ...
    known_for: ['1984', 'Rebelión en la Granja', 'Homenaje a Cataluña'],
    works: [
      { id: 'b3', title: '1984', cover: 'https://readdy.ai/api/search-image?query=dystopian%20surveillance%20dark%20eye%20watching%20dramatic%20dark%20book%20cover%20artistic%20illustration%20cold%20tones&width=280&height=380&seq=pw-1984-go&orientation=portrait', year: 1949, genre: 'Distopía', category: 'books', rating: 9.2, role: 'Autor' },
      { id: 'animal-farm', title: 'Rebelión en la Granja', cover: 'https://readdy.ai/api/search-image?query=farm%20animals%20political%20satire%20book%20cover%20artistic%20illustration%20warm%20tones&width=280&height=380&seq=pw-af&orientation=portrait', year: 1945, genre: 'Sátira', category: 'books', rating: 9.0, role: 'Autor' },
    ],
  },
  'patrick-rothfuss': {
    id: 'patrick-rothfuss',
    ...
    works: [
      { id: 'b4', title: 'El Nombre del Viento', cover: 'https://readdy.ai/api/search-image?query=fantasy%20magic%20wind%20dramatic%20sky%20book%20cover%20artistic%20illustration%20warm%20tones%20epic&width=280&height=380&seq=pw-nv-pr&orientation=portrait', year: 2007, genre: 'Fantasía', category: 'books', rating: 9.1, role: 'Autor' },
      { id: 'wise-mans-fear', title: 'El Temor de un Hombre Sabio', cover: 'https://readdy.ai/api/search-image?query=fantasy%20magic%20adventure%20dramatic%20sky%20book%20cover%20artistic%20illustration%20warm%20tones%20epic%20sequel&width=280&height=380&seq=pw-wmf&orientation=portrait', year: 2011, genre: 'Fantasía', category: 'books', rating: 9.0, role: 'Autor' },
    ],
  },
  'yuval-noah-harari': {
    ...
    known_for: ['Sapiens', 'Homo Deus', '21 lecciones para el siglo XXI'],
    works: [
      { id: 'b5', title: 'Sapiens', cover: 'https://readdy.ai/api/search-image?query=human%20evolution%20history%20dramatic%20artistic%20book%20cover%20illustration%20earth%20civilization&width=280&height=380&seq=pw-sap-ynh&orientation=portrait', year: 2011, genre: 'No ficción', category: 'books', rating: 8.8, role: 'Autor' },
      { id: 'homo-deus', title: 'Homo Deus', cover: 'https://readdy.ai/api/search-image?query=future%20human%20technology%20sci-fi%20book%20cover%20artistic%20illustration%20futuristic%20tones&width=280&height=380&seq=pw-hd&orientation=portrait', year: 2015, genre: 'No ficción', category: 'books', rating: 8.5, role: 'Autor' },
      { id: '21-lessons', title: '21 lecciones para el siglo XXI', cover: 'https://readdy.ai/api/search-image?query=modern%20society%20technology%20book%20cover%20artistic%20illustration%20contemporary%20tones&width=280&height=380&seq=pw-21l&orientation=portrait', year: 2018, genre: 'No ficción', category: 'books', rating: 8.3, role: 'Autor' },
    ],
  },
  'carlos-ruiz-zafon': {
    ...
    known_for: ['La Sombra del Viento', 'El Juego del Ángel', 'El Prisionero del Cielo'],
    works: [
      { id: 'b6', title: 'La Sombra del Viento', cover: 'https://readdy.ai/api/search-image?query=gothic%20barcelona%20mystery%20dark%20cemetery%20dramatic%20lighting%20book%20cover%20artistic%20illustration&width=280&height=380&seq=pw-sv-crz&orientation=portrait', year: 2001, genre: 'Misterio', category: 'books', rating: 9.0, role: 'Autor' },
      { id: 'angel-game', title: 'El Juego del Ángel', cover: 'https://readdy.ai/api/search-image?query=gothic%20mystery%20dark%20barcelona%20dramatic%20book%20cover%20artistic%20illustration%20dark%20tones&width=280&height=380&seq=pw-jda&orientation=portrait', year: 2008, genre: 'Misterio', category: 'books', rating: 8.7, role: 'Autor' },
      { id: 'prisoner-heaven', title: 'El Prisionero del Cielo', cover: 'https://readdy.ai/api/search-image?query=gothic%20mystery%20prison%20dark%20dramatic%20book%20cover%20artistic%20illustration%20dark%20tones&width=280&height=380&seq=pw-pdc&orientation=portrait', year: 2011, genre: 'Misterio', category: 'books', rating: 8.5, role: 'Autor' },
    ],
  },
  'isaac-asimov': {
    id: 'isaac-asimov',
    ...
    known_for: ['Fundación', 'Yo, Robot', 'La Trilogía de la Fundación'],
    works: [
      { id: 'b7', title: 'Fundación', cover: 'https://readdy.ai/api/search-image?query=galactic%20empire%20sci-fi%20space%20dramatic%20artistic%20book%20cover%20illustration%20stars%20civilization&width=280&height=380&seq=pw-found-ia&orientation=portrait', year: 1951, genre: 'Sci-Fi', category: 'books', rating: 9.3, role: 'Autor' },
      { id: 'i-robot', title: 'Yo, Robot', cover: 'https://readdy.ai/api/search-image?query=robot%20artificial%20intelligence%20sci-fi%20book%20cover%20artistic%20illustration%20futuristic%20tones&width=280&height=380&seq=pw-ir&orientation=portrait', year: 1950, genre: 'Sci-Fi', category: 'books', rating: 9.0, role: 'Autor' },
      { id: 'foundation-empire', title: 'Fundación e Imperio', cover: 'https://readdy.ai/api/search-image?query=galactic%20empire%20sci-fi%20space%20dramatic%20artistic%20book%20cover%20illustration%20stars%20civilization%20sequel&width=280&height=380&seq=pw-fe&orientation=portrait', year: 1952, genre: 'Sci-Fi', category: 'books', rating: 9.1, role: 'Autor' },
    ],
  },
  'gabriel-garcia-marquez': {
    ...
    known_for: ['Cien Años de Soledad', 'El Amor en los Tiempos del Cólera', 'Crónica de una Muerte Anunciada'],
    works: [
      { id: 'b8', title: 'Cien Años de Soledad', cover: 'https://readdy.ai/api/search-image?query=magical%20realism%20latin%20america%20tropical%20dramatic%20artistic%20book%20cover%20illustration%20warm%20tones&width=280&height=380&seq=pw-cien-ggm&orientation=portrait', year: 1967, genre: 'Realismo mágico', category: 'books', rating: 9.5, role: 'Autor' },
      { id: 'love-cholera', title: 'El Amor en los Tiempos del Cólera', cover: 'https://readdy.ai/api/search-image?query=romantic%20latin%20america%20tropical%20dramatic%20artistic%20book%20cover%20illustration%20warm%20tones&width=280&height=380&seq=pw-atc&orientation=portrait', year: 1985, genre: 'Romance', category: 'books', rating: 9.1, role: 'Autor' },
      { id: 'chronicle-death', title: 'Crónica de una Muerte Anunciada', cover: 'https://readdy.ai/api/search-image?query=latin%20america%20mystery%20dramatic%20artistic%20book%20cover%20illustration%20warm%20tones&width=280&height=380&seq=pw-cma&orientation=portrait', year: 1981, genre: 'Misterio', category: 'books', rating: 8.9, role: 'Autor' },
    ],
  },
  // ── Game studios ──
  'fromsoftware': {
    ...
    known_for: ['Elden Ring', 'Dark Souls', 'Sekiro', 'Bloodborne'],
    works: [
      { id: 'g1', title: 'Elden Ring', cover: 'https://readdy.ai/api/search-image?query=Elden%20Ring%20fantasy%20dark%20souls%20epic%20landscape%20golden%20tree%20dramatic%20sky%20cinematic%20game%20art%20dark%20moody&width=280&height=380&seq=pw-er&orientation=portrait', year: 2022, genre: 'RPG', category: 'games', rating: 9.4, role: 'Desarrollador' },
      { id: 'sekiro', title: 'Sekiro: Shadows Die Twice', cover: 'https://readdy.ai/api/search-image?query=japanese%20samurai%20ninja%20dark%20dramatic%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-sek&orientation=portrait', year: 2019, genre: 'Acción', category: 'games', rating: 9.2, role: 'Desarrollador' },
      { id: 'ds3', title: 'Dark Souls III', cover: 'https://readdy.ai/api/search-image?query=dark%20souls%20knight%20fire%20dramatic%20dark%20fantasy%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-ds3&orientation=portrait', year: 2016, genre: 'RPG', category: 'games', rating: 9.0, role: 'Desarrollador' },
      { id: 'bloodborne', title: 'Bloodborne', cover: 'https://readdy.ai/api/search-image?query=gothic%20horror%20victorian%20dark%20dramatic%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-bb2&orientation=portrait', year: 2015, genre: 'RPG', category: 'games', rating: 9.3, role: 'Desarrollador' },
    ],
  },
  'larian-studios': {
    id: 'larian-studios',
    ...
    known_for: ["Baldur's Gate 3", 'Divinity: Original Sin 2', 'Divinity: Original Sin'],
    works: [
      { id: 'g2', title: "Baldur's Gate 3", cover: 'https://readdy.ai/api/search-image?query=fantasy%20RPG%20dark%20dungeon%20magic%20spell%20dramatic%20lighting%20epic%20game%20art%20dark%20purple%20tones%20cinematic&width=280&height=380&seq=pw-bg3-ls&orientation=portrait', year: 2023, genre: 'RPG', category: 'games', rating: 9.6, role: 'Desarrollador' },
      { id: 'dos2', title: 'Divinity: Original Sin 2', cover: 'https://readdy.ai/api/search-image?query=fantasy%20RPG%20magic%20battle%20dramatic%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-dos2&orientation=portrait', year: 2017, genre: 'RPG', category: 'games', rating: 9.4, role: 'Desarrollador' },
    ],
  },
  'santa-monica-studio': {
    ...
    known_for: ['God of War', 'God of War Ragnarök', 'God of War (2018)'],
    works: [
      { id: 'g3', title: 'God of War Ragnarök', cover: 'https://readdy.ai/api/search-image?query=Norse%20mythology%20warrior%20axe%20snow%20dramatic%20sky%20epic%20cinematic%20game%20art%20cold%20tones&width=280&height=380&seq=pw-gow-sms&orientation=portrait', year: 2022, genre: 'Acción', category: 'games', rating: 9.3, role: 'Desarrollador' },
      { id: 'gow2018', title: 'God of War (2018)', cover: 'https://readdy.ai/api/search-image?query=Norse%20mythology%20warrior%20father%20son%20dramatic%20sky%20epic%20cinematic%20game%20art%20cold%20tones&width=280&height=380&seq=pw-gow18&orientation=portrait', year: 2018, genre: 'Acción', category: 'games', rating: 9.5, role: 'Desarrollador' },
    ],
  },
  'cd-projekt-red': {
    id: 'cd-projekt-red',
    ...
    known_for: ['Cyberpunk 2077', 'The Witcher 3', 'The Witcher 2'],
    works: [
      { id: 'g4', title: 'Cyberpunk 2077', cover: 'https://readdy.ai/api/search-image?query=cyberpunk%20neon%20city%20night%20futuristic%20urban%20rain%20dramatic%20lighting%20yellow%20tones%20cinematic&width=280&height=380&seq=pw-cp-cdpr&orientation=portrait', year: 2020, genre: 'RPG', category: 'games', rating: 8.7, role: 'Desarrollador' },
      { id: 'witcher3', title: 'The Witcher 3: Wild Hunt', cover: 'https://readdy.ai/api/search-image?query=fantasy%20RPG%20witcher%20monster%20hunter%20dramatic%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-w3&orientation=portrait', year: 2015, genre: 'RPG', category: 'games', rating: 9.7, role: 'Desarrollador' },
    ],
  },
  'team-cherry': {
    id: 'team-cherry',
    ...
    works: [
      { id: 'g5', title: 'Hollow Knight', cover: 'https://readdy.ai/api/search-image?query=dark%20fantasy%20insect%20knight%20underground%20cave%20glowing%20mushrooms%20atmospheric%20game%20art%20blue%20tones&width=280&height=380&seq=pw-hk-tc&orientation=portrait', year: 2017, genre: 'Metroidvania', category: 'games', rating: 9.1, role: 'Desarrollador' },
    ],
  },
  'rockstar-games': {
    id: 'rockstar-games',
    ...
    known_for: ['Red Dead Redemption 2', 'GTA V', 'GTA VI'],
    works: [
      { id: 'g6', title: 'Red Dead Redemption 2', cover: 'https://readdy.ai/api/search-image?query=wild%20west%20cowboy%20sunset%20dramatic%20landscape%20horse%20cinematic%20warm%20tones%20epic%20game%20art&width=280&height=380&seq=pw-rdr-rg&orientation=portrait', year: 2018, genre: 'Aventura', category: 'games', rating: 9.5, role: 'Desarrollador' },
      { id: 'gta5', title: 'Grand Theft Auto V', cover: 'https://readdy.ai/api/search-image?query=los%20angeles%20city%20crime%20action%20dramatic%20cinematic%20game%20art%20warm%20tones&width=280&height=380&seq=pw-gta5&orientation=portrait', year: 2013, genre: 'Acción', category: 'games', rating: 9.2, role: 'Desarrollador' },
    ],
  },
  'bandai-namco': {
    id: 'bandai-namco',
    ...
    known_for: ['Elden Ring', 'Dark Souls', 'Tekken', 'Pac-Man'],
    works: [
      { id: 'g1', title: 'Elden Ring', cover: 'https://readdy.ai/api/search-image?query=Elden%20Ring%20fantasy%20dark%20souls%20epic%20landscape%20golden%20tree%20dramatic%20sky%20cinematic%20game%20art%20dark%20moody&width=280&height=380&seq=pw-er-bn&orientation=portrait', year: 2022, genre: 'RPG', category: 'games', rating: 9.4, role: 'Publisher' },
      { id: 'tekken8', title: 'Tekken 8', cover: 'https://readdy.ai/api/search-image?query=fighting%20game%20martial%20arts%20dramatic%20cinematic%20game%20art%20dark%20tones&width=280&height=380&seq=pw-tek8&orientation=portrait', year: 2024, genre: 'Lucha', category: 'games', rating: 8.8, role: 'Desarrollador / Publisher' },
    ],
  },
};

// Map from person name (as appears in item details) to person id
export const PERSON_NAME_TO_ID: Record<string, string> = {
  ...
  'Bella Ramsey': 'bella-ramsey',
  'Gabriel Luna': 'gabriel-luna',
  'Anna Torv': 'anna-torv',
  'Adam Scott': 'adam-scott',
  'Britt Lower': 'britt-lower',
  ...
  'Carlos Ruiz Zafón': 'carlos-ruiz-zafon',

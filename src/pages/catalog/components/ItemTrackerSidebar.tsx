        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 flex items-center justify-center rounded-lg bg-red-50 dark:bg-red-950/30">
              <i className="ri-flag-2-line text-red-500 text-sm"></i>
            </div>
            <div>
...
const STATUS_OPTIONS: { value: TrackerStatus; label: string; icon: string; color: string; bg: string }[] = [
  ...
  { value: 'dropped',     label: 'Abandonado',  icon: 'ri-close-circle-line',    color: 'text-red-600 dark:text-red-400',   bg: 'bg-red-50 dark:bg-red-950/30' },
];
    ...
    <>
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-100 dark:border-zinc-800">
        ...
        <div className="px-5 pt-5 pb-4 border-b border-zinc-100 dark:border-zinc-800">
          <h3 className="text-xs font-bold text-zinc-500 dark:text-zinc-500 uppercase tracking-wider">
            Mi tracker
          </h3>
        </div>
                  ...
                  <div className="flex flex-col gap-1.5 px-1 py-1">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-zinc-500 flex items-center gap-1.5">
                        <i className="ri-calendar-add-line text-zinc-600"></i>
                        Añadido
                      </span>
                    ...
                    {entry.updatedAt !== entry.addedAt && (
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-zinc-500 flex items-center gap-1.5">
                          <i className="ri-refresh-line text-zinc-600"></i>
                          Actualizado
                        </span>
              ...
              >
                <div className={`w-7 h-7 flex items-center justify-center rounded-lg flex-shrink-0 ${
                  ...
                  <i className={`ri-shield-check-line text-sm ${
                    reportsPending > 0 ? 'text-red-500' : 'text-zinc-400'
                  }`}></i>
                </div>
                <div className="flex-1 min-w-0">
                  <p className={`text-xs font-semibold ${
                    reportsPending > 0 ? 'text-red-600 dark:text-red-400' : 'text-zinc-500 dark:text-zinc-400'
                  }`}>

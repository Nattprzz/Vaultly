...
const FAQ_CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'No, los Términos de Uso de Vaultly permiten una única cuenta por persona. Si necesitas acceso para un equipo o uso profesional, escríbenos a contacto@vaultlytracker.com.',
        link: null,
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Puedes eliminar tu cuenta y todos los datos asociados desde Ajustes → Cuenta. Si necesitas una eliminación específica de ciertos datos o tienes una solicitud RGPD, escríbenos a privacidad@vaultlytracker.com.',
        link: null,
      },
    ],
  },
...
const CONTACT_CARDS = [
  {
    ...
    value: 'contacto@vaultlytracker.com',
    href: 'mailto:contacto@vaultlytracker.com',
  },
  {
    icon: 'ri-tools-line',
    color: 'text-sky-500',
    ...
    desc: 'Incidencias y ayuda técnica',
    value: 'soporte@vaultlytracker.com',
    href: 'mailto:soporte@vaultlytracker.com',
  },
  {
    icon: 'ri-shield-check-line',
    ...
    value: 'privacidad@vaultlytracker.com',
  ...
  },
  {
    ...
    value: 'legal@vaultlytracker.com',
              ...
              {submitStatus === 'error' && (
                <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800">
                  ...
                  <p className="text-sm text-red-600 dark:text-red-400">
                    ...
                    <a href="mailto:contacto@vaultlytracker.com" className="font-semibold underline">contacto@vaultlytracker.com</a>.
                  </p>
                </div>
              )}
